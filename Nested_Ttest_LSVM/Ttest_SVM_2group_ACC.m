function Accuracy = Ttest_SVM_2group_ACC(Subjects_Data, Subjects_Label, P_Value, Pre_Method)
%
% Copyright(c) 2016
...
for i = 1:Subjects_Quantity
    ...
    [predicted_labels(i), ~, DecisionValues(i)] = svmpredict(test_label, test_data_New, model(i));
